...
public abstract class AbstractProtocol extends Ruleform {
	...
	public String getToString() {
		return String
				.format("requester=%s, assignTo=%s, service=%s, product=%s, deliverTo=%s, deliverFrom=%s, requesterAttribute=%s, assignToAttribute=%s, serviceAttribute=%s, productAttribute=%s, deliverToAttribute=%s, deliverFromAttribute=%s, quantity=%s, quantityUnit=%s",
						getRequester().getName(), getAssignTo().getName(),
						getService().getName(), getProduct().getName(),
						getDeliverTo().getName(), getDeliverFrom().getName(),
						getRequesterAttribute().getName(),
						getAssignToAttribute().getName(), getServiceAttribute()
								.getName(), getProductAttribute().getName(),
	...
	public String toString() {
		return String
				.format("AbstractProtocol [requester=%s, assignTo=%s, service=%s, product=%s, deliverTo=%s, deliverFrom=%s, requesterAttribute=%s, assignToAttribute=%s, serviceAttribute=%s, productAttribute=%s, deliverToAttribute=%s, deliverFromAttribute=%s, quantity=%s, quantityUnit=%s]",
						getRequester().getName(), getAssignTo().getName(),
						getService().getName(), getProduct().getName(),
						getDeliverTo().getName(), getDeliverFrom().getName(),
						getRequesterAttribute().getName(),
