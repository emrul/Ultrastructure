...
public abstract class AttributeValue<RuleForm extends Ruleform> extends
	...
	public byte[] getBinaryValue() {
		if (getAttribute().getValueType() != ValueType.BINARY) {
			throw new UnsupportedOperationException(String.format(
					...
					ValueType.BINARY, getAttribute().getValueType()));
		}
		return binaryValue;
	}
	...
	public Boolean getBooleanValue() {
		if (getAttribute().getValueType() != ValueType.BOOLEAN) {
			throw new UnsupportedOperationException(String.format(
					"May not retrieve %s value for a %s attribute",
					ValueType.BOOLEAN, getAttribute().getValueType()));
		}
	...
	public Integer getIntegerValue() {
		if (getAttribute().getValueType() != ValueType.INTEGER) {
			throw new UnsupportedOperationException(String.format(
					"May not retrieve %s value for a %s attribute",
					ValueType.INTEGER, getAttribute().getValueType()));
		}
		return integerValue;
	}
	...
	public BigDecimal getNumericValue() {
		if (getAttribute().getValueType() != ValueType.NUMERIC) {
			throw new UnsupportedOperationException(String.format(
					"May not retrieve %s value for a %s attribute",
					ValueType.NUMERIC, getAttribute().getValueType()));
		}
		return numericValue;
	}
	...
	public String getTextValue() {
		if (getAttribute().getValueType() != ValueType.TEXT) {
			throw new UnsupportedOperationException(String.format(
					"May not retrieve %s value for a %s attribute",
					ValueType.TEXT, getAttribute().getValueType()));
		}
		return textValue;
	}
	...
	public <T> T getValue() {
		...
		default:
			throw new IllegalStateException(String.format(
					"Invalid value type: %s", getAttribute().getValueType()));
		}
	}
	...
	public void setTimestampValue(Timestamp timestampValue) {
		if (getAttribute().getValueType() != ValueType.TIMESTAMP) {
			throw new UnsupportedOperationException(String.format(
					"May not set %s value for a %s attribute",
					ValueType.TIMESTAMP, getAttribute().getValueType()));
		}
