...
@NamedQueries({ @NamedQuery(name = GET_ATTRIBUTE, query = "select ra from LocationAttribute ra where ra.location = :location and ra.attribute = :attribute") })
public class LocationAttribute extends AttributeValue<Location> {
    private static final long  serialVersionUID = 1L;
    public static final String GET_ATTRIBUTE    = "locationAttribute.getAttribute";
