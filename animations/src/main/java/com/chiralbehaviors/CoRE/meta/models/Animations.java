...
public class Animations implements Triggers {
	 ...
	 * 
	 * @see
	 * com.chiralbehaviors.CoRE.Triggers#delete(com.chiralbehaviors.CoRE.agency
	 * .Agency)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.chiralbehaviors.CoRE.Triggers#delete(com.chiralbehaviors.CoRE.attribute
	 * .Attribute)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.chiralbehaviors.CoRE.Triggers#delete(com.chiralbehaviors.CoRE.time
	 * .Interval)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.chiralbehaviors.CoRE.Triggers#delete(com.chiralbehaviors.CoRE.location
	 * .Location)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.chiralbehaviors.CoRE.Triggers#delete(com.chiralbehaviors.CoRE.network
	 * .NetworkInference)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.chiralbehaviors.CoRE.Triggers#delete(com.chiralbehaviors.CoRE.product
	 * .Product)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.chiralbehaviors.CoRE.Triggers#delete(com.chiralbehaviors.CoRE.event
	 * .status.StatusCode)
	 */
	@Override
	...
	public void flush() {
		...
		try {
			...
			throw new TriggerException(
					"StatusCodeSequencing validation failed", e);
		}
	 ...
	 * 
	 * @see
	 * com.chiralbehaviors.CoRE.Triggers#persist(com.chiralbehaviors.CoRE.agency
	 * .AgencyNetwork)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.chiralbehaviors.CoRE.Triggers#persist(com.chiralbehaviors.CoRE.attribute
	 * .AttributeNetwork)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.chiralbehaviors.CoRE.Triggers#persist(com.chiralbehaviors.CoRE.time
	 * .IntervalNetwork)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.chiralbehaviors.CoRE.Triggers#persist(com.chiralbehaviors.CoRE.event
	 * .Job)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.chiralbehaviors.CoRE.Triggers#persist(com.chiralbehaviors.CoRE.location
	 * .LocationNetwork)
	 */
	@Override
	 ...
	 * @see
	 * com.chiralbehaviors.CoRE.Triggers#persist(com.chiralbehaviors.CoRE.event
	 * .ProductChildSequencingAuthorization)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.chiralbehaviors.CoRE.Triggers#persist(com.chiralbehaviors.CoRE.product
	 * .ProductNetwork)
	 */
	@Override
	 ...
	 * @see
	 * com.chiralbehaviors.CoRE.Triggers#persist(com.chiralbehaviors.CoRE.event
	 * .ProductParentSequencingAuthorization)
	 */
	@Override
	 ...
	 * @see
	 * com.chiralbehaviors.CoRE.Triggers#persist(com.chiralbehaviors.CoRE.event
	 * .ProductSelfSequencingAuthorization)
	 */
	@Override
	 ...
	 * @see
	 * com.chiralbehaviors.CoRE.Triggers#persist(com.chiralbehaviors.CoRE.event
	 * .ProductSiblingSequencingAuthorization)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.chiralbehaviors.CoRE.Triggers#persist(com.chiralbehaviors.CoRE.network
	 * .RelationshipNetwork)
	 */
	@Override
	...
	private void process(Job j) {
		...
		jobModel.generateImplicitJobsForExplicitJobs(j, model.getKernel()
	 ...
	 * 
	 * @see
	 * com.chiralbehaviors.CoRE.Triggers#update(com.chiralbehaviors.CoRE.event
	 * .Job)
	 */
	@Override
	...
	private void validateChildSequencing() {
		for (ProductChildSequencingAuthorization pcsa : childSequences) {
			...
			try {
				model.getJobModel().ensureValidServiceAndStatus(
						pcsa.getNextChild(), pcsa.getNextChildStatus());
			} catch (SQLException e) {
				throw new TriggerException(String.format(
						"Invalid sequence: %s", pcsa), e);
			}
		}
	}
	...
	private void validateParentSequencing() {
		for (ProductParentSequencingAuthorization ppsa : parentSequences) {
			try {
				model.getJobModel().ensureValidServiceAndStatus(
						ppsa.getParent(), ppsa.getParentStatusToSet());
			} catch (SQLException e) {
	...
	private void validateSelfSequencing() {
		for (ProductSelfSequencingAuthorization pssa : selfSequences) {
			try {
				model.getJobModel().ensureValidServiceAndStatus(
						pssa.getService(), pssa.getStatusToSet());
			} catch (SQLException e) {
				throw new TriggerException("Invalid sequence", e);
			}
		}
	...
	private void validateSiblingSequencing() {
		for (ProductSiblingSequencingAuthorization pssa : siblingSequences) {
			try {
				model.getJobModel().ensureValidServiceAndStatus(
						pssa.getNextSibling(), pssa.getNextSiblingStatus());
			} catch (SQLException e) {
				throw new TriggerException("Invalid sequence", e);
			}
		}
